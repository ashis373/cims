      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {scope === "all" ? "candidates (all)" : scope === "filtered" ? "candidates (filtered view)" : "selected candidates"}.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-2">
          <Button variant="outline" className="justify-start h-auto py-3" onClick={() => handle(() => exportXlsx(candidates), "Excel")}>
          ...
          <Button variant="outline" className="justify-start h-auto py-3" onClick={() => handle(() => exportCsv(candidates), "CSV")}>
          ...
          <Button variant="outline" className="justify-start h-auto py-3" onClick={() => handle(() => exportBossReport(candidates), "Boss Report")}>
            <FileBarChart2 className="mr-3 h-5 w-5 text-violet-600" />
            <div className="text-left">
              <div className="font-medium">Boss Report (.xlsx)</div>
              <div className="text-xs text-muted-foreground">Summary + funnel + candidate detail</div>
            </div>
          </Button>
        </div>
        <DialogFooter>
