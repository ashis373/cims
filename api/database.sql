...
DROP TABLE IF EXISTS `cims_candidates_normalized`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `cims_candidates_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cims_candidates_old` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_candidates_stage_role` (`stage`,`role`),
  KEY `idx_candidates_recruiter` (`recruiter`),
  KEY `idx_candidates_appliedAt` (`appliedAt`),
  KEY `idx_candidates_name` (`name`),
  KEY `idx_candidates_phone` (`phone`),
  KEY `idx_candidates_email` (`email`),
  KEY `idx_candidates_stage` (`stage`),
  KEY `idx_candidates_duplicate_check` (`email`,`phone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `system_blacklist_reasons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `system_company_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `system_recruitment_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `system_rejection_reasons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2026-08-22 10:38:38
