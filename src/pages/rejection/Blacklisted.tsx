          ...
          <div className="flex flex-col md:flex-row items-start md:items-center p-5 gap-5">
            ...
            <div className="flex items-center justify-between w-full md:w-auto md:min-w-[240px] lg:min-w-[280px]">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl text-[14px] font-black uppercase shadow-sm border bg-slate-900 text-white border-slate-800">
                  {c.name?.charAt(0) || "?"}
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:flex flex-1 gap-4 w-full md:w-auto">
              ...
              <div className="col-span-2 sm:col-span-1 md:flex-[1.5] md:min-w-[160px] lg:min-w-[200px]">
                ...
                <div className="inline-flex max-w-full">
                  <div className="text-[11px] md:text-[12px] font-bold truncate px-2 md:px-3 py-1 md:py-1.5 rounded-lg border bg-slate-50 text-slate-700 border-slate-200" title={c.reason}>
